...
![image.png](/Screenshot2025-08-07at9.21.29PM.png)
...
[**_<u>The bundle creates a role that can authenticate to NetSuite's API. For a full list of the role's permissions, see this article. The permissions may be updated, or a separate Role may be used, but doing so could result in permission issues.</u>_**](https://help.merge.dev/en/articles/8250738-netsuite-bundle-details#h_b3d0a0731b)
